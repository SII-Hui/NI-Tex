...
* **Image prompt:** Rename your provided image prompt to `image_prompt.png`.
...
We edited the BEDLAM data using **Nano Banana** and rendered this massive dataset via Blender Python across a cluster of **48 RTX 4090 GPUs**.
